  ...
  return (
    <div>
      <div className="home__data">
        <h1 className="home__title">Hedi Samet
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm Computer Engineer and Graphic Designer based in Tunisia, and I'm very passionate and dedicated to my work.</p>
